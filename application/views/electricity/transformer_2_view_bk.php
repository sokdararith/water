					...
					<div class="innerLR">
						<div class="navbar">
							<div class="navbar-inner">
								<ul class="nav">
									<li><a href="<?php echo base_url(); ?>electricity/index/#/licensees">អតិថិជនជាអ្នកកាន់អាជ្ញាប័ណ្ណ</a></li>
									<li><a href="<?php echo base_url(); ?>electricity/index/#/distribution">មធ្យោបាយចែកចាយ</a></li>
								</ul>
							</div>
						</div>
					</div>	
...
<script>
    ...
    $.getJSON(ARNY.baseUrl + "api/accounting_api/class_dropdown", function(data) {
	 	$.each(data, function(key, val) {
	    	classVM.classes.push({id: val.id, name: val.name});
		});	
	});
