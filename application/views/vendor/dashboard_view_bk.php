<div class="widget widget-heading-simple widget-body-gray widget-employees">
		...
		<!-- <div class="widget-head">
			<h4 class="heading glyphicons user"><i></i>ទំព័រអ្នកផ្គត់ផ្គង់</h4>			
		</div> -->
		<!-- // Widget Heading END -->
		...
		<div class="widget-body padding-none">	
			<div class="row-fluid row-merge">
				<div class="span3 listWrapper" style="height: 630px;">
					...
					<ul class="list unstyled" id="vendorList" style="height: 560px;"></ul>
				</div>
...
<script id="appIndex" type="text/x-kendo-template">
	<div id="info">fsdfdsf</div>
	<div id="content" style="padding-top: 10px;">fsdfsdf</div>
</script>
...
<script id="billGrid" type="text/x-kendo-template">
	<tr data-bind="click: change" data-id="#:id#">
		<td>
...
<script id="cartTmpl" type="text/x-kendo-template">
	<tr>
		...
		<td><i class="icon-plus" data-bind="click: addToCart"></i><i class="icon-trash" data-bind="click: remove"></i></td>
	</tr>
</script>
