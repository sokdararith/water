<div class="row-fluid">    
	<div class="span12">
		<div id="example" class="k-content">
			<h1><i class="icon-spinner icon-spin icon-large"></i> ចុះឈ្មោះអតិថិជនថ្មី <span>ផ្នែកអគ្គីសនី</span></h1>
			...
			<div class="widget widget-tabs widget-tabs-gray widget-tabs-vertical row-fluid row-merge margin-none widget-body-white">
				...
				<div class="widget-head span2">
					<ul>						
						<li class="active"><a class="glyphicons electricity" href="#electricity-customer" data-toggle="tab"><i></i>អតិថិជនអគ្គីសនី</a></li>	
						<li><a class="glyphicons user" href="<?php echo base_url(); ?>customer/add_customer_normal/"><i></i>អតិថិជនធម្មតា</a></li>						
					</ul>
				</div>
				<!-- // Widget heading END -->
...
var viewModel = kendo.observable({	
	...
	addCustomer		: function(){
		customerDS.add({
			...
			transformer_id	: this.get("transformer_id").id,	
			...
			round_settle	: this.get("round_settle"),	
